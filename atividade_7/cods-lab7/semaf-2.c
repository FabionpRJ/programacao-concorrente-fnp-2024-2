...
/*
      1. Leia o programa para entender como ele funciona. Acompanhe a explanac ¸˜ ao da
      professora.
      2. Com quais valores os sem´aforos devem ser inicializados?
      3. Execute o programa v´ arias vezes e observe os resultados impressos na tela
...
void *t1 (void *arg) {
   ...
   sem_post(&estado1); //Manda um sinal para o estado 1.
...
int main(int argc, char *argv[]) {
  ...
  sem_init(&estado2, 0, 0);
   ...
   /*Note, os semáforos começam sem permitir que ninguém ultrapasse até t1/t2 mandar um sinal.*/
